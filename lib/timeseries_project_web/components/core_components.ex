defmodule TimeseriesProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TimeseriesProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TimeseriesProjectWeb.Gettext, "errors", msg, opts)
    end
  end
